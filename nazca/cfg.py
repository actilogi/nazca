...
# Set True to use a convex hull of istances in the cell
# for bounding box calculations.
# A convex hull gives an instance rotation proof bbox.
# It may take several times longer to generate a mask.
# Without use_hull = False and in case instances are flattened
# the bbox of the parent cell may look too large
# as it is based on the corners of the rotated bbox that are not visualized.
# default = False
use_hull = False
...
# Raise an exception on netlist connection errors
# This helps identifying where the exception occurs in the code.
# default = False
netlist_raise = False


# Raise an exception on interconnect warnings
# This helps identifying where the exception occurs in the code.
# default = False
...
# style of pcell parameters in the cells
parameter_style = 'default'



# Convert polylines into polygons in gds export
# Note this conversion happens automatically for formats without lines, e.g. png.
# default = False
