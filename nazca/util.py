...
def polyline2polygon(xy, width=2, width2=None, parabolic=True, miter=0.5, anglei=None, angleo=None):
...
def polyline2polygon_asym(xy, width1, width2=None, grow=None, parabolic=True,
        miter=0.5, anglei=None, angleo=None):
